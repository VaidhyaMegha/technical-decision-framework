...
#   c.executemany("UPDATE answers (id,questionid,answertext,correct) VALUES (?,?,?,?)", insert_values)
...
if __name__ == '__main__':
  db = sqlite3.connect("quiz.sqlite")
  ...
  print ("\nThanks for participating! - Vaidhya Megha")
  print ( "Dear " + player.get_name() + "\nYour Final score: " + str(player.score))
  ...
  for hs_entry in dbh.get_highscores():
    ...
    indic = "<------ITS YOU" if hs_entry['id'] == player.get_id() else ""
